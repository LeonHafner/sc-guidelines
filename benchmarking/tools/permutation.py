...
parser.add_argument('--kang2018', action='store_true', help='Activate when using with Kang2018 dataset')
...
if kang2018:
    adata.obs.columns = ["Batch", "Sample", "Condition", "n_obs"]
